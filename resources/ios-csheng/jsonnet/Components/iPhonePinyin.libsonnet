        ...
        subviews: [
					...
					},
          {
            Cell: params.keyboard.spaceButton.name,
					...
					{
            Cell: params.keyboard.cn2enButton.name,
					},
          {
...
local newKeyLayout(isDark=false, isPortrait=true) =
  ...
  + basicStyle.newAlphabeticButton(
    ...
    isDark,
      ...
      foregroundStyle: params.keyboard.semicolonButton.foregroundStyle(isDark),
  ...
  // 中文键盘的中英切换按钮 - 固定显示 "中"，点击切换到 alphabetic 键盘
  + basicStyle.newSystemButton(
    params.keyboard.cn2enButton.name,
    isDark,
    {
      size: { width: '110/1125' },
    } + params.keyboard.cn2enButton.params
  )
  + {
