...
// 工具栏按钮前景色
local toolbarButtonForegroundColor = labelColor.fifth;

// 工具栏按钮高亮前景色
local toolbarButtonHighlightedForegroundColor = toolbarButtonForegroundColor;
